                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Dental Specialist',
                              style: TextStyle(color: MyColors.text01),
                            ),
                          ],
                        ),
                      ],
      ...
      child: Row(
        ...
        children: [
          Padding(
            ...
            child: Icon(Icons.search, color: MyColors.purple02),
          ),
      ...
      children: [
        ...
        IconButton(
          onPressed: () => Navigator.push(
            context,
            MaterialPageRoute(
              builder: (ctx) => const InformationScreen(title: 'Notification'),
            ),
          ),
